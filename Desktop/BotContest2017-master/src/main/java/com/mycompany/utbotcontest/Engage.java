    ...
    public Player stateEngage() throws IOException {
        ...
        if (!enemy.isVisible()) {
            ...
            if(mainBot.getLeft90()) {
                mainBot.getMove().strafeRight(longueurStrafe, enemy);
            }   
            else if (mainBot.getRight90()) {
                mainBot.getMove().strafeLeft(longueurStrafe, enemy);
            }
            else {
                int randX = (random.nextInt()%250) + 25;
